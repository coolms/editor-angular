...
All 11 of this package's specs run in the admin SPA suite, which imports each one by path from `packages/theme-admin/angular/src/editor-angular-specs.spec.ts`. That suite last ran 1215 of 1215 green. The tests are real and they do execute -- just not here, and not as a gate on a pull request opened against this repository.
